...
$this->pages['all']['terms-conditions']['document_elements'] = array(
    array(
        'content' => '<i>' . sprintf(_x('This Cookie Policy was last updated on %s and applies to citizens of the European Economic Area.', 'Legal document cookie policy', 'complianz-terms-conditions'), '[publish_date]') . '</i>',
    ),
    array(
        'title' => _x('Introduction', 'Legal document cookie policy:paragraph title', 'complianz-terms-conditions'),
        'content' => sprintf(_x('Our website, %s (hereinafter: "the website") uses cookies and other related technologies (for convenience all technologies are referred to as "cookies"). Cookies are also placed by third parties we have engaged. In the document below we inform you about the use of cookies on our website.', 'Legal document cookie policy', 'complianz-terms-conditions'), '[domain]', '[article-cookie_names]'),
    ),
    array(
        'title' => _x('What are cookies?', 'Legal document cookie policy:paragraph title', 'complianz-terms-conditions'),
        'content' => _x('A cookie is a small simple file that is sent along with pages of this website and stored by your browser on the hard drive of your computer or another device. The information stored therein may be returned to our servers or to the servers of the relevant third parties during a subsequent visit.', 'Legal document cookie policy', 'complianz-terms-conditions'),
    ),
    array(
        'title' => _x('What are scripts?', 'Legal document cookie policy:paragraph title', 'complianz-terms-conditions'),
        'content' => _x('A script is a piece of program code that is used to make our website function properly and interactively. This code is executed on our server or on your device.', 'Legal document cookie policy', 'complianz-terms-conditions'),
    ),
    array(
        'title' => _x('What is a web beacon?', 'Legal document cookie policy:paragraph title', 'complianz-terms-conditions'),
        'content' => _x('A web beacon (or a pixel tag) is a small, invisible piece of text or image on a website that is used to monitor traffic on a website. In order to do this, various data about you is stored using web beacons.', 'Legal document cookie policy', 'complianz-terms-conditions'),
    ),

    array(
	    'title' => _x('Cookies', 'Legal document cookie policy:paragraph title', 'complianz-terms-conditions'),
    ),

    array(
	    'subtitle' => _x('Technical or functional cookies', 'Legal document cookie policy:paragraph title', 'complianz-terms-conditions'),
	    'content' => _x('Some cookies ensure that certain parts of the website work properly and that your user preferences remain known. By placing functional cookies, we make it easier for you to visit our website. This way, you do not need to repeatedly enter the same information when visiting our website and, for example, the items remain in your shopping cart until you have paid. We may place these cookies without your consent.', 'Legal document cookie policy', 'complianz-terms-conditions'),
    ),

	//analytical
    array(
	    'subtitle' => _x('Analytical cookies', 'Legal document cookie policy:paragraph title', 'complianz-terms-conditions'),
