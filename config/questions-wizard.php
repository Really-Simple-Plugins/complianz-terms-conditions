...
$this->fields = $this->fields + array(
		...
		'legal_mention' => array(
			...
			'comment'			=> __( "If you don't have the relevant documents, please have a look at Complianz - The Privacy Suite for WordPress.",
					'complianz-terms-conditions' ). '</br>' . cmplz_tc_read_more( 'https://complianz.io/tc-required-legal-documents/' ),
			'options'  => $this->yes_no,
		...
		'cookie_policy' => array(
			...
			'comment'			=> __( "Complianz GDPR/CCPA Cookie Consent can create one for you.", 'complianz-terms-conditions' ),
			'condition' => array(
				'legal_mention' => 'yes',
			),
		),
		...
		'disclosure_company' => array(
			...
			'comment'			=> __( "If you have an Impressum generated by Complianz, please check how you can transfer your current Impressum.",
					'complianz-terms-conditions' ). '</br>' . cmplz_tc_read_more( 'https://complianz.io/transferring-your-impressum/' ),
			'condition' => array(
